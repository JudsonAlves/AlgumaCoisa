...
<div style="position:sticky;top:86px">
  ...
  document.getElementById('btnLimpar').addEventListener('click', () => {
    OS = { itensPlaca:[], itensInversor:[], itensBateria:[], itensOutros:[], itensMateriais:[], cliente:null, vendedor:null, estrutura:null, prefill:null, propostaConfig: propostaConfigPadrao() };
    pageOrcamento();
  });
